...
<!-- Mirrored from www.technomarket.bg/lg-certificate-2016-klimatik by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 14:07:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>LG Air Conditioner СЕРТИФИКАТ - Електромаркет - онлайн магазин</title>
...
<script type="text/javascript">
    ...
    <div class="heading">
     ...
     <nav class="navbar">
        ...
        <iframe src = "pdf/Technomarket_LG_Certificate_2016.pdf" width='100%' height='800' allowfullscreen webkitallowfullscreen></iframe>
        </div>
