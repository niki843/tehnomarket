...
<head>
                                            <title>Бърза и безплатна доставка до дома Ви - Електромаркет - онлайн магазин</title>
     ...
     <nav class="navbar">
        ...
        <section class=" section section-odd" >
            <div class="container">
                    ...
                    <h2>Бърза и безплатна доставка до дома Ви</h2>
                                    </div><!-- /.section-heading -->
                                <div class="row">
                                                            <div class="col-auto" >
...
Ние, в Електромаркет, имаме за основен приоритет да отговаряме винаги на потребителското търсене като предоставим на клиентите си богат асортимент от потребителска електроника, електротехника, офис оборудване и телекомуникационни продукти и услуги, отговарящи на най-новите технологии и достижения в тази сфера, с гарантирано качество, конкурентни пазарни цени, както и осигурена сервизна поддръжка. Като компания, която среща своите клиенти с авангарда и иновацията, ние се стремим винаги да сме най-информирани, най-радикални, да сме първи, да сме гъвкави и да помагаме на нашите клиенти да направят правилния избор.</p>

<p>Срокът за доставката до дома Ви е в рамките от 24 часа до 4 &nbsp;работни дни след поръчката с изключение на официалните празници. Възможни са забавяния, за които ще бъдете уведомени от наш сътрудник или със съобщение на нашия сайт.</p>

<p><strong>Доставката е безплатна за продукти със стойност над 50лв</strong>., а за тези под посочената сума е 4лв. за цялата страна.</p>

<p>Докато формирате Вашата поръчка за покупка от онлайн магазина, ще видите празно поле &ldquo;Забележки&rdquo;. В него може да упоменете удобния ден за доставка и ние ще се съобразим с Вашето желаение, ако е възможно спрямо графика за обслужване на Вашето населено място.</p>

<p><strong>Доставката се извършва:</strong></p>

<ol>
	<li>До вратата на апартамента за функциониращи жилищни сгради и работещ асансъор</li>
	<li>До входа на сградата, когато няма работещ асаньор</li>
	<li>До вратата на двора, при къщи с дворно място</li>
</ol>

<p>Работното време на куриерите е от 10:00 до 18:00ч.</p>

<p>Електромаркет не носи отговорност за закъснение в случай, че забавянето се дължи на куриер или поради независещи от Електромаркет обстоятелства.<br />
Веднага след доставката, стоките следва да бъдат прегледани внимателно от потребителя/клиента или упълномощено от него лице. При евентуални повреди, удари и други щети установени при доставка следва да бъде незабавно уведомен сътрудник от отдел Електронна търговия на тел <strong>070010800 или по мейл на </strong><a href="mailto:mailelectromarket@gmail.com"><strong>mailelectromarket@gmail.com</strong></a> .</p>

<p>При приемане на пратката от купувача без забележки, всички претенции поради загуба или механично повреждане губят валидност. Ако не бъде изготвен протокол за щети в присъствието на куриера при получаването на пакета, се губи възможността за подаване на оплакване.</p>

<p>В случаите, когато от Електромаркет са зададени в писмена форма конкретни дата и час за доставка, изявлението има обвързваща сила. При посочени неверен или сгрешен адрес, лице за контакти и/или телефон при подаване на заявката, Електромаркет не е обвързан от каквото и да е задължение за изпълнение на поръчката.<br />
При предаване на стоката потребителят/клиентът или трето лице подписват придружаващите я документи. За трето лице се счита всеки, който не е титуляр на заявлението, но приема стоката на доставка и е на посочения от клиента адрес.<br />
В случай, че Клиентът не бъде намерен в срока за изпълнение на доставката на посочения адрес или не бъде осигурен достъп и условия за предаване на стоката в този срок, Електромаркет се освобождава от задължението си да достави заявената за покупка стока.<br />
Когато доставената стока явно несъответства на заявената за покупка от Клиента стока и това може да се установи чрез обикновения й преглед, клиентът може да поиска доставената му стока да &nbsp;бъде заменена със съответстваща на направеното от него заявление за покупка в срок от 24 часа от получаването и.</p>

<p>&nbsp;</p>

<p>Клиента има право да се откажете от поръчаните стоки в срок от 14&nbsp;ДНИ от получаване на стоките, в случай,че същите са с не нарушена цялост на опаковката и стоката е във вида, в който е получена с придружаващата я документация (фактура и гаранционна карта) и при условията по чл.55 от ЗЗП.</p>

<p>За да удовлетворим Вашите изисквания за бързата доставка до Вашата врата на поръчаните уреди, ние работим с водещи куриерски фирми на българския пазар.</p>
            </div>
        </div>
    </div>
