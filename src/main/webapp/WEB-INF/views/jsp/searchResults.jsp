...
<meta property="og:title"
	content="Продукти - Електромаркет - онлайн магазин" />
			...
			<c:forEach items="${foundProducts}" var="product">
				<div class="col-md-3">
					<figure itemscope itemtype="http://schema.org/Product"
						class="product">
						<a itemprop="url" href="/Electromarket/productInfo?product=${ product.getProduct_id() }" class="product-thumb"> 
						<img itemprop="image" src="${ product.getRealtivePath()}" alt="Electromarket" />
						</a>
						<figcaption>
							<div class="product-name">
								<h3>
									<a itemprop="url" href="/Electromarket/productInfo?product=${ product.getProduct_id() }"> 
