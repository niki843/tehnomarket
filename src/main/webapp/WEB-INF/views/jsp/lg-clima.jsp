...
<p>Програмата &bdquo;5 години гаранция&rdquo; е валидна при представяне на фактура/касова бележка, указаваща вашата покупка, коректно попълнено гаранционно писмо, както и документа, който можете да свалите&nbsp;<a href="/Electromarket/lgClimaCertificate">тук</a>.</p>

<p>&nbsp;</p>

<p>Моля, обърнете внимание, че при закупуване на&nbsp;<strong>Климатик от LG</strong>, с маркировка LG Electronics Magyar Kft., трябва да получите и официална гаранционна карта. Вижте примера&nbsp;<a href="/Electromarket/lgClimaWarranty">тук</a>.</p>
            </div>
        </div>
    </div>
