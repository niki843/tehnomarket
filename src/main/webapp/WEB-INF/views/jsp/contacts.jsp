...
<head>
                                            <title>За контакти - Електромаркет - онлайн магазин</title>
...
<body itemscope itemtype="http://schema.org/WebPage" id="top" class="">
	...
	<header>
     ...
     <nav class="navbar">
        ...
        <section class=" section-split section-odd" >
            <div class="container">
    ...
    <div class="container-inner">
        <div class="container-cell">
                                    <form name="contact_form" method="post" action="/Electromarket/sendMessage" class="form-horizontal"><div id="contact_form"><div class="form-group"><label  class="col-sm-6 control-label required" for="contact_form_name">
                    Име
                    ...
                    E-mail
                                            <span class="required" title="This field is required">*</span></label><div class="col-sm-10 control-bar"><input type="email" id="contact_form_email" name="contact_form[email]" required="required" class="form-control" /><span class="bar"></span></div></div><div class="form-group"><label  class="col-sm-6 control-label required" for="contact_form_tel">
                    Телефон
...
<input type="hidden" id="contact_form__token" name="contact_form[_token]" class="form-control" value="KjxdUcKGrkUz5hDnfjapRzsQHHCn37yElSaYT-WudSU" /></div></form>
