...
<!-- Mirrored from www.technomarket.bg/hotpoint-promo by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:07:17 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>Промоция на Hotpoint перални - Електромаркет - онлайн магазин</title>
     ...
     <nav class="navbar">
        ...
        <section class=" section section-even" >
        	...
        	<div class="figure-image">
                                <picture>                	
                    <source srcset="img/hotpoint2.jpg" media="(max-width: 990px)" />
                    <img src="img/hotpoint2.jpg" alt="" title="">
                </picture>
                            </div>
        </figure>        
    </div>
...
<h3>както и сушилня <strong>HOTPOINT ARISTON</strong> със 16 програми, регулиране на температурата и програма за вълна <strong>за 579 лв.</strong></h3>

<h3>И това не е всичко - сега двата уреда в перфектна комбинация - <strong>само за 999 лв. с 5 години пълна гаранция.</strong></h3>
            </div>
        </div>
    </div>
        ...
        <section class=" section section-odd" >
	    	...
	    	<div class="container-inner">
        	<div class="container-cell">
                <iframe width="1280" height="720" src="https://www.youtube.com/embed/vM1gwoSC2oI?rel=0" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
...
<!-- Mirrored from www.technomarket.bg/hotpoint-promo by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:07:18 GMT -->
</html>