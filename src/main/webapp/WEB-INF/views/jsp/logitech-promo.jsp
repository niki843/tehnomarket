...
<!-- Mirrored from www.technomarket.bg/logitech-promo by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:08:09 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>Logitech Промоция - Електромаркет - онлайн магазин</title>
     ...
     <nav class="navbar">
        ...
        <section class=" section section-odd" >
        	...
        	<div class="container-cell">
                <p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/banner-top1420x300.jpg" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-102.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-3.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-4.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-5.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-6.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-71.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-8.png" /></p>

<p style=" margin-top: 0px; margin-bottom: 0px;"><img alt="" src="img/logitec-lp-9.png" /></p>
