...
<!-- Mirrored from www.technomarket.bg/lg-garancionna-karta by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 14:07:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>Официална гаранционна карта - LG - Електромаркет - онлайн магазин</title>
...
<script type="text/javascript">
    ...
    <div class="heading">
     ...
     <nav class="navbar">
        ...
        <iframe src = "pdf/garancionna-karta.pdf" width='100%' height='800' allowfullscreen webkitallowfullscreen></iframe>
        </div>
