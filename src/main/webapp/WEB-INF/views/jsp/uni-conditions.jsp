...
<head>
                                            <title>Условия за UniCredit кредитиране - Електромаркет - онлайн магазин</title>
...
<p><br />
<br />
<font face="tahoma, arial, helvetica, sans-serif">​</font><b>ИНСТРУКЦИЯ &ndash; ПОКУПКА НА ИЗПЛАЩАНЕ СУНИКРЕДИТ КЪНСЮМЪР ФАЙНЕНСИНГ ОТ ОНЛАЙН МАГАЗИНА НА Електромаркет</b></p>
...
<p>11. След катоУниКредит получи коректно подписаните документи, служител на Електромаркет ще се свърже с Вас, за да уточните доставката на стоката.</p>
            </div>
        </div>
    </div>
