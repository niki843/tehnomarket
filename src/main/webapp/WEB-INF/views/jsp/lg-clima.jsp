...
<!-- Mirrored from www.technomarket.bg/lg-clima-5-godini-garancia by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:08:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>5 години гаранция на климатици LG - Електромаркет - онлайн магазин</title>
     ...
     <div class="col-md-16 text-center" >
	    <div class="container-inner">
        	<div class="container-cell">
                <p><img alt="" src="img/1420x3005godini-garanciq-3.png" /></p>
            </div>
        </div>
    </div>
        ...
        <section class=" section section-odd" >
	    	...
	    	<div class="container-inner">
        	<div class="container-cell">
                <p>&quot;5 години гаранция&quot; ви дава възможност за закупуване на&nbsp;<strong>Климатик от LG*&nbsp;</strong>при специални условия. В периода&nbsp;<strong>1 септември, 2016 - 31 декември, 2016&nbsp;</strong>за всеки закупен Inverter V /&nbsp;Smart Inverter,&nbsp;маркиран с LG Electronics Magyar Kft., стандартната гаранцията от 3 години от датата на покупка е удължена на 5 години.</p>
            </div>
        </div>
    </div>
        	...
        	<div class="figure-image">
                                <picture>                	
                    <source srcset="img/pics-BG-5-godini-garancija-V2.jpg" media="(max-width: 990px)" />
                    <img src="img/pics-BG-5-godini-garancija-V2.jpg" alt="" title="">
                </picture>
                            </div>
        </figure>        
    </div>
	    	...
	    	<div class="container-inner">
        	<div class="container-cell">
                <p><strong>&quot;5 години гаранция&quot; от LG</strong></p>

<p>&nbsp;</p>

<p>Програмата &bdquo;5 години гаранция&rdquo; е валидна при представяне на фактура/касова бележка, указаваща вашата покупка, коректно попълнено гаранционно писмо, както и документа, който можете да свалите&nbsp;<a href="/Technomarket/lgClimaCertificate">тук</a>.</p>

<p>&nbsp;</p>

<p>Моля, обърнете внимание, че при закупуване на&nbsp;<strong>Климатик от LG</strong>, с маркировка LG Electronics Magyar Kft., трябва да получите и официална гаранционна карта. Вижте примера&nbsp;<a href="/Technomarket/lgClimaWarranty">тук</a>.</p>
            </div>
        </div>
    </div>
...
<!-- Mirrored from www.technomarket.bg/lg-clima-5-godini-garancia by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:08:17 GMT -->
</html>>