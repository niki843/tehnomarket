...
<!-- Mirrored from www.technomarket.bg/technomarket-broshura-30-09-2016 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:07:53 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>Промоционална брошура на Електромаркет - Октомври 2016 - Технoмаркет - онлайн магазин</title>
...
<script type="text/javascript">
   ...
   <div class="col-md-16" >
        ...
        <iframe src = "pdf/broshura.pdf" width='100%' height='800' allowfullscreen webkitallowfullscreen></iframe>
        </div>
