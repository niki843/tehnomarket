...
<!-- Mirrored from www.technomarket.bg/vaucher-technomarket by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:08:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<head>
                                            <title>Подаръчни ваучери от Електромаркет - Електромаркет - онлайн магазин</title>
...
<script type="text/javascript">
    ...
    <div class="heading">
     ...
     <nav class="navbar">
        ...
        <section class=" section-split section-brp section-odd" >
            <div class="container">
            	                <div class="row">
                                                            <div class="col-md-16" >
...
<p><font color="#808080" size="2">Подаръчни ваучери от Техномаркет</font></p>

<p><strong><font color="#ff0000" face="verdana" size="2">Удобство за Вас, елегантна изненада за близките!</font></strong><br />
Изберете подаръчен ваучер за вашите близки и познати!<br />
Ако се колебаете за конкретната сума, то вземете нашия специален ваучер и<br />
добавете сумата, която вие желаете!</p>

<p>Ваучерът е валиден за магазини Техномаркет в България (не може да се използва за онлайн пазаруване в www.techomarket.bg).</p>

<p>Ваучерът не дава възможност за допълнителни отстъпки на артикули в пакетни цени.</p>

<p>Ваучерът важи за получаване на стока от Техномаркет .&nbsp;</p>

<p>Ваучерът може да се използва еднократно и сумата, описана в него, не може да се изплаща в брой.</p>

<p>Ваучерът е валиден за срок от една година от датата на покупка.</p>

<p>&nbsp;</p>

<p><img alt="" src="img/TM_Tematichni-vaucheri-1.1.png" /></p>
