...
<!-- Mirrored from www.technomarket.bg/lg-tv-5years-warranty by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:07:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
                                            <title>Модели телевизори LG с удължена гаранция - Технoмаркет - онлайн магазин</title>
    ...
    <nav class="navbar">
        ...
        <section class=" section section-even" >
            <div class="container">
                    ...
                    <h2>Промоция &quot;5 години грижа за клиента&quot; от LG</h2>
                                    </div><!-- /.section-heading -->
                                <div class="row">
        	...
        	<div class="figure-image">
                                <picture>                	
                    <source srcset="img/991x220-lg-tv.png" media="(max-width: 990px)" />
                    <img src="img/991x220-lg-tv.png" alt="" title="">
                </picture>
                            </div>
        </figure>        
    </div>
        	...
        	<div class="container-cell">
                <p>В рамките на промоция &quot;5 години грижа за клиента&quot; имате възможност да закупите 2016 LG ULTRA HD LED 4K телевизор при специални условия.</p>

<p>&nbsp;</p>

<p>Промоцията е валидна за посочените модели, предлагани на пазара от LG Electronics Magyar Kft. и закупени в&nbsp; периода&nbsp; 1-октомври 2016 - 15-януари, 2017 на територията на България.</p>

<p>&nbsp;</p>

<p>Стандартната 2 годишна пълна гаранция се удължава до 5 години грижа за клиента, валидна от датата на покупка. През указания период всяка покупка на посочените модели осигурява безплатна поправка и подмяна на части, в случай че се наложи сервизиране на продукта. Посочените условия са валидни при представяне на фактура или касов бон, гаранционна карта, както и &bdquo;5 години грижа за клиента&rdquo; сертификат, който може да бъде свален от долу посочения линк.</p>

<p><strong>Повече информация за промоцията:</strong></p>

<p>Програмата &bdquo;5 години грижа за клиента&rdquo; е валидна при представяне на фактура/касова бележка, указаваща вашата покупка, коректно попълнена гаранционна карта, както и документа, който можете да свалите тук.</p>

<p>&nbsp;</p>

<p>Моля, уверете се, че&nbsp; опаковката на телевизора - пуснат на пазара от LG Electronics Magyar Kft.-&nbsp; съдържа официалната гаранционна карта. Можете да намерите по-долу образец.</p>

<p><br />
<a class="add-section btn btn-default" href="lg-tv-5years-warranty-pravila.html">Правила и условия на промоцията &quot;5 ГОДИНИ ГРИЖА ЗА КЛИЕНТА&quot;</a></p>
            </div>
        </div>
    </div>
...
<!-- Mirrored from www.technomarket.bg/lg-tv-5years-warranty by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Oct 2016 13:07:29 GMT -->
</html>